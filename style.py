...
def makeColorTable(reverse=False):
    ...
    # print("colorlist[0]: ", *colorList[0])
    # print("colorlist[1]: ", *colorList[1])

    # colorList = [
    #    [0.,newColorHLS(0.1, 0.47,0.6)],
    #    [0.,newColorHLS(0.5, 0.65, 0.7)],
    #    [0.,newColorHLS(0.9, 1., 1.)],
    # ]
    ...
    # mypalette = []
    # for i in range(200):
    #     mypalette.append(start+i)

    # ROOT.gStyle.SetPalette(200, mypalette)
...
def makeLumiText(x1, y1, lumi, year):
    ...
    pText.AddText(str(lumi)+" pb#lower[-0.8]{#scale[0.7]{-1}}")
...
def makeTextAngle(x1,y1,x2,y2,angle,text):
    pText = ROOT.TPaveText(x1,y1,x1,y1,"NDC")
    pText.AddText(text)
    pText.SetTextFont(43)
    pText.SetTextSize(25)
